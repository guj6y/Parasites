function [res,con,n_new,c_new,r_new,C_web]= ...
     NicheModelPara_nk(num_species, C, Np)                
%------------------------------------------------------------------
...
para = datasample(1:num_species,Np);
parasites = zeros(num_species,1);
parasites(para) = true;
Nf = num_species - Np;
