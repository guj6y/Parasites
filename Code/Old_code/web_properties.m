...
%%-------------------------------------
    nichewithoucann=nicheweb; %removes cannibalism
    nichewithoucann(eye(nichewebsize)>0)=0;
    
    topsp = find(sum(nichewithoucann,1)==0);   % indices of top species (no pred besides themselves)
...
%%           loops = cannibalism)
%% ChLen --> Mean Length of a food chainb (that is, links from any species
