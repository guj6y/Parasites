...
It could be partially explained by parasites going extinct at disproportionately higher levels.  This true to some extent, but is not the whole story (see figures \ref{fig:persistenceFree} and \ref{fig:persistencePara} in sections \sec{sec:persistenceFree} and \sec{sec:persistencePara},respectively).
