...
\addplot+[
		  only marks, \markOne, \colorOne,
          error bars/.cd,
		  y explicit, y dir=both,
		]
table[\colorOne,x =x,y =y,y error =yp,col sep = comma]{#1-small-small-subplot-#2};
\addplot+[
		  only marks, \markTwo, \colorTwo,
          error bars/.cd,
		  y explicit, y dir=both,
		]
table[\colorTwo,x =x,y =y,y error =yp,col sep = comma]{#1-small-big-subplot-#2};
\addplot+[
		  only marks, \markThree, \colorThree,
          error bars/.cd,
		  y explicit, y dir=both,
		]
table[\colorThree,x =x,y =y,y error =yp,col sep = comma]{#1-big-small-subplot-#2};
\addplot+[
		  only marks, \markFour, \colorFour,
          error bars/.cd,
		  y explicit, y dir=both,
		]
table[\colorFour,x =x,y =y,y error =yp,col sep = comma]{#1-big-big-subplot-#2};
